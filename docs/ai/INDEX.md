...
| Cross-section article priority | [`decisions/cross-section-article-priority.md`](decisions/cross-section-article-priority.md) | duplicate, canonical URL, article identity, section, personal news, today internet | active | 2026-09-17 | 上位sectionを優先する同一記事排除と過剰dedupe防止 |
| News card information hierarchy | [`decisions/news-card-information-hierarchy.md`](decisions/news-card-information-hierarchy.md) | score, importance, verification, why-hot, personal news, topic card | active | 2026-09-17 | 内部scoreと表示labelを分離し、importanceと確認状況を別概念として扱う |
| Classic first-view priority | [`decisions/classic-first-view-priority.md`](decisions/classic-first-view-priority.md) | Classic, hero, first view, Today Internet, Game Hub, layout | active | 2026-09-15 | ニュースを初期viewportとGame Hubより先に置くUI優先順位 |
...
| Article and summary identity | [`lessons/article-summary-identity.md`](lessons/article-summary-identity.md) | canonical URL, metadata, summary, duplicate, archive, cache, no-result, HTTP error, bot challenge | active | 2026-09-14 | 別記事の要約と取得エラー文の混入を防ぐintegrity規則 |
| Brand signal classification | [`lessons/brand-signal-classification.md`](lessons/brand-signal-classification.md) | category, brand, pokemon, sourceTags, feed, false positive | active | 2026-09-17 | Feed全体tagを個別記事のbrand evidenceとして扱わない |
