...
const CATEGORY_RULES = [
  ...
  { key: "adult", pattern: /アダルト|av女優|セクシー女優|グラビア(?:アイドル)?|水着グラビア|写真集|デジタル写真集|グラドル|ランジェリー|ビキニ|下着姿|水着姿|水着|セクシーショット|美ボディ|豊満ボディ|美バスト|美尻|谷間|艶姿|くびれ|ボディライン|肌見せ|大胆カット|悩殺|抜群スタイル|r18|porn|adult|fanza|dlsite|dmm|美少女ゲーム|アイドル.{0,10}(?:グラビア|写真集|水着|ビキニ|ランジェリー)|(?:グラビア|写真集|水着|ビキニ|ランジェリー).{0,10}アイドル/ },
...
function hasStrongAdultContext(value) {
  return /av女優|セクシー女優|グラビア(?:アイドル)?|水着グラビア|写真集|デジタル写真集|グラドル|ランジェリー|ビキニ|下着姿|水着姿|水着|セクシーショット|美ボディ|豊満ボディ|美バスト|美尻|谷間|艶姿|くびれ|ボディライン|肌見せ|大胆カット|悩殺|抜群スタイル|r18|porn|adult|fanza|dlsite|dmm|gカップ|セクシー/.test(value);
}
...
function isFalsePositiveMatomeSignal(value) {
  ...
  return /(サウンドバー|スピーカー|ホームシアター|オーディオ|アンプ|スピーカ[ーｰ]|テレビ|tv|番組|放送|1泊家族|[257]\.1\.2ch|[257]\.1ch|2chのデジタル・ミキサー)/.test(text);
}
...
function isMatomeContext(value) {
  return /なんj|なんg|j民|g民|2chまとめ|5chまとめ|2chスレ|5chスレ|スレまとめ|まとめブログ|まとめサイト|2ch面白いスレ|2ch有益スレ|反応集|ネットの反応|なんj反応|なんg反応|はちま|オタコム|痛いニュース|俺的ゲーム速報|暇人速報|アルファルファモザイク|ゆっくり(?:解説|実況)?/.test(String(value ?? "").toLowerCase());
}
