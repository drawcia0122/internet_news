...
const CATEGORY_STYLES = {
  ...
  adult: { label: "アダルト系", color: "#ff91b9", searchQuery: "グラビア 写真集 デジタル写真集 水着 ランジェリー セクシーショット セクシー女優 AV女優 アダルト 話題" },
...
const CATEGORY_RULES = [
  ...
  { key: "adult", pattern: /アダルト|av女優|セクシー女優|グラビア|写真集|デジタル写真集|グラドル|ランジェリー|水着姿|水着|セクシーショット|美ボディ|r18|porn|adult|fanza|dlsite|dmm|美少女ゲーム/ },
