...
function isLikelyIconOrLogo(url) {
  return isKnownGooglePlaceholderImage(url)
    ...
    || /(?:^|[/?#&=_-])(logo|icon|sns-share|share-icon|social-icon|site-logo|header-logo|brand-logo|profile_images|profile_banners|ext_tw_video_thumb|entry-button)(?:[/?#&=._-]|$)/i.test(url)
